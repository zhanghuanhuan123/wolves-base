...
public abstract class nsPSMDetector {
    ...
    public nsPSMDetector() {
        initVerifiers(org.mozilla.intl.chardet.nsPSMDetector.ALL);
        Reset();
    }
    ...
    protected void initVerifiers(int currVerSet) {
        ...
        if (currVerSet >= 0 && currVerSet < NO_OF_LANGUAGES) {
            ...
            currVerifierSet = org.mozilla.intl.chardet.nsPSMDetector.ALL;
        }

        mVerifier = null;
        mStatisticsData = null;

        if (currVerifierSet == org.mozilla.intl.chardet.nsPSMDetector.TRADITIONAL_CHINESE) {
        ...
        //==========================================================
        else if (currVerifierSet == org.mozilla.intl.chardet.nsPSMDetector.KOREAN) {
        ...
        //==========================================================
        else if (currVerifierSet == org.mozilla.intl.chardet.nsPSMDetector.SIMPLIFIED_CHINESE) {
        ...
        //==========================================================
        else if (currVerifierSet == org.mozilla.intl.chardet.nsPSMDetector.JAPANESE) {
        ...
        //==========================================================
        else if (currVerifierSet == org.mozilla.intl.chardet.nsPSMDetector.CHINESE) {
        ...
        //==========================================================
        else if (currVerifierSet == org.mozilla.intl.chardet.nsPSMDetector.ALL) {
